...
return {
    setup = function(p, hi)
        ...
        hi('Folded',         {fg=p.base04, bg=nil,      attr=nil,            sp=nil})
        hi('IncSearch',      {fg=p.base00, bg=p.base09, attr=nil,            sp=nil})
        hi('lCursor',        {fg=p.base01, bg=p.base05, attr=nil,            sp=nil})
        hi('LineNr',         {fg=p.base03, bg=nil,      attr=nil,            sp=nil})
        hi('LineNrAbove',    {fg=p.base03, bg=nil,      attr=nil,            sp=nil})
        hi('LineNrBelow',    {fg=p.base03, bg=nil,      attr=nil,            sp=nil})
